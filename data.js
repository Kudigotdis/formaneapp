...
window.DEMO_ACCOUNTS = [
  ...
  { id: 'supplier', name: 'Board Kings', role: 'Business & Materials Supplier', initials: 'BK', color: '#ed6626', town: 'Gaborone', logo: 'assets/images/company_logos_dummy/Board_Kings_Logo_.webp' },
  ...
  { id: 'owner-biz2', name: 'BuildIt Gabs', role: 'Business Owner', initials: 'BG', color: '#1a4b8c', town: 'Gaborone' },
  { id: 'owner-biz3', name: 'Francistown Steel', role: 'Business Owner', initials: 'FS', color: '#ed6626', town: 'Francistown' },
  { id: 'owner-biz4', name: 'Gabs Plumbing Depot', role: 'Business Owner', initials: 'GP', color: '#009144', town: 'Gaborone' },
