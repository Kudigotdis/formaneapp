...
function updateAccountHero() {
  ...
  if (customAvatar) {
    ...
    avatar.innerHTML = '<img src="' + window.assetUrl('assets/images/company_logos_dummy/new_wirog_logo22.webp') + '" style="width:120px;height:120px;border-radius:8px;object-fit:cover;display:block;border:3px solid rgba(200,200,200,0.2);">';
  } else if (isAdmin) {
