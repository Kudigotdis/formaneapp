...
async function main() {
  ...
  if (!fs.existsSync(cfgPath)) { console.error('foromane-config.json not found'); process.exit(1); }
  ...
  if (!clientId || !clientSecret) { console.error('Missing client_id/client_secret in foromane-config.json'); process.exit(1); }
