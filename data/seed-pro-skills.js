(function() {
  if (localStorage.getItem('wirog_pro_skills_seeded_v2')) return;
  ...
  function seedPro(pro) {
    ...
    try {
      localStorage.setItem('wirog_pro_profile_' + proId, JSON.stringify({
      ...
      localStorage.setItem('wirog_skill_ratings_' + proId, JSON.stringify(ratingsData));
    } catch(e) {
  ...
  localStorage.setItem('wirog_pro_skills_seeded_v2', '1');
})();
