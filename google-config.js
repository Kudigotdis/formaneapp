...
// Generated from your private foromane-config.json (keep that file private).

const googleConfig = {
  clientId: "977050279257-97rltt8ldnr96fgmi4klbsglgrlavk97.apps.googleusercontent.com",
  rootFolderName: "Foromane App Drive",
...
console.log('  Firebase: https://foromane-app.web.app/oauth-callback');
console.log('  GitHub:   https://kudigotdis.github.io/foromaneapp/oauth-callback');
