/* ════════════════════════════════════════════════════════
   WIROG STAFF - Business staff management & Join Business
   ════════════════════════════════════════════════════════ */
...
function getStaffPermKey(businessId) { return `wirog_staff_permissions_${businessId}`; }
function getPendingKey(businessId) { return `wirog_pending_staff_${businessId}`; }
