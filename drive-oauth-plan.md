...
This document lists steps to set up Drive-based backup/sync for Wirog.

1. Create GCP Project
   - Console: https://console.cloud.google.com
   - New project name: "Wirog App - Sync"
...
6. Data model & mapping
   - Each user: create a folder named `wirog_<userId>` in Drive (store folderId in server DB)
